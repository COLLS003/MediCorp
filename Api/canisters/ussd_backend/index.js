...
import { idlFactory } from './ussd_backend.did.js';
export { idlFactory } from './ussd_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.USSD_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ussd_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ussd_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ussd_backend.did.js")._SERVICE>}
 */
export const ussd_backend = createActor(canisterId);
