...
import { idlFactory } from './ussd_frontend.did.js';
export { idlFactory } from './ussd_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.USSD_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ussd_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ussd_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ussd_frontend.did.js")._SERVICE>}
 */
export const ussd_frontend = createActor(canisterId);
